...
import AwaitingDoctorListView from '.';

describe('AwaitingDoctorListView', () => {
  it('should render each outpatient card with patient name given outpatient list has at least a patient awaiting doctor', async () => {
    const {getByText} = renderWithProviders(<AwaitingDoctorListView />);
  ...
  it('should render each outpatient card with patient code, age and gender given outpatient list has at least a patient awaiting doctor', async () => {
    const {getByText} = renderWithProviders(<AwaitingDoctorListView />);
